...
@section('content')
    ...
    <h2 style="font-size:20px;font-weight:700;color:var(--ev-text);margin:0 0 4px;">Create New OKR</h2>
    <p style="font-size:13px;color:var(--ev-text-secondary);margin:0 0 24px;">Define your objective, key results, and success criteria.</p>
